...
class Modificar_Pelicula(QDialog):
    def __init__(self, data_transferida=None):
        QDialog.__init__(self)
        archivo = os.getcwd().split('src')[0] + r'\src\views\ui\modificar.ui'
        ...
        pixmap = QPixmap(r'{0}\src\views\ui\img\imgmodifi.png'.format(os.getcwd().split("src")[0]))
